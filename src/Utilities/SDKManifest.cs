...
namespace net.r_eg.IeXod.Utilities
{
    ...
    public class SDKManifest
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible", Scope = "type", Target = "net.r_eg.IeXod.Utilities.SDKManifest+Attributes", Justification = "Not worth breaking customers / spending resources to fix.")]
