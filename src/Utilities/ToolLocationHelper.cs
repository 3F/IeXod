...
namespace net.r_eg.IeXod.Utilities
{
    ...
    public static class ToolLocationHelper
    {
        ...
        /// <summary>
        /// Converts a member of the net.r_eg.IeXod.Utilities.DotNetFrameworkArchitecture enum to the equivalent member of the 
        /// net.r_eg.IeXod.Shared.DotNetFrameworkArchitecture enum. 
        /// </summary>
