...
namespace net.r_eg.IeXod.Shared
{
    ...
    internal static class AssemblyResources
    {
        ...
        internal static ResourceManager PrimaryResources { get; } = new ResourceManager("net.r_eg.IeXod.Utilities.Core.Strings", typeof(AssemblyResources).GetTypeInfo().Assembly);
        ...
        internal static ResourceManager SharedResources { get; } = new ResourceManager("net.r_eg.IeXod.Utilities.Core.Strings.shared", typeof(AssemblyResources).GetTypeInfo().Assembly);
