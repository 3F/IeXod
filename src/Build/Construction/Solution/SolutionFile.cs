...
using VisualStudioConstants = net.r_eg.IeXod.Shared.VisualStudioConstants;
using ProjectFileErrorUtilities = net.r_eg.IeXod.Shared.ProjectFileErrorUtilities;
using BuildEventFileInfo = net.r_eg.IeXod.Shared.BuildEventFileInfo;
using ResourceUtilities = net.r_eg.IeXod.Shared.ResourceUtilities;
using ExceptionUtilities = net.r_eg.IeXod.Shared.ExceptionHandling;
