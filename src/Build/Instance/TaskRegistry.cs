...
namespace net.r_eg.IeXod.Execution
{
    ...
    /// </remarks>
    /// <example>
    /// &lt;UsingTask TaskName="net.r_eg.IeXod.Tasks.Csc"                     ==> look for the "Csc" task in the
    ///            AssemblyName="net.r_eg.IeXod.Tasks"/&gt;                       weakly-named "net.r_eg.IeXod.Tasks" assembly
    /// 
    ...
    internal sealed class TaskRegistry : ITranslatable
    {
        ...
        /// </summary>
        private static string s_tasksV4SimpleName = "net.r_eg.IeXod.Tasks.v4.0";
        ...
        /// task factory UsingTasks
        /// </summary>
        private static string s_tasksV12SimpleName = "net.r_eg.IeXod.Tasks.v12.0";
        ...
        private static bool IsTaskFactoryClass(Type type, object unused)
        {
            return (type.GetTypeInfo().IsClass &&
                ...
                typeof(net.r_eg.IeXod.Framework.ITaskFactory).IsAssignableFrom(type));
        }
        ...
        internal class RegisteredTaskRecord : ITranslatable
        {
            ...
            /// supported task factories in net.r_eg.IeXod.Tasks.vX.Y.dll to deal with versioning issue. 
            /// </summary>
