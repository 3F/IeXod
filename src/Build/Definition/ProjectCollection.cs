...
using InternalLoggerException = net.r_eg.IeXod.Exceptions.InternalLoggerException;
using InvalidProjectFileException = net.r_eg.IeXod.Exceptions.InvalidProjectFileException;
using LoggerMode = net.r_eg.IeXod.BackEnd.Logging.LoggerMode;
...
namespace net.r_eg.IeXod.Evaluation
{
    ...
    public class ProjectCollection : IToolsetProvider, IBuildComponent, IDisposable
    {
        ...
        public Project LoadProject(string fileName, IDictionary<string, string> globalProperties, string toolsVersion)
        {
            ...
            using (_locker.EnterWriteLock())
            {
                ...
                if (project == null)
                {
                    ...
                    project = new Project(fileName, globalProperties, new ProjectToolsOptions(effectiveToolsVersion), this);
                }
        ...
        {
            return new Project(xmlReader, globalProperties, new ProjectToolsOptions(toolsVersion), this);
        }
