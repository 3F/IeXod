...
using EvaluationItemSpec = net.r_eg.IeXod.Evaluation.ItemSpec<net.r_eg.IeXod.Evaluation.ProjectProperty, net.r_eg.IeXod.Evaluation.ProjectItem>;
using EvaluationItemExpressionFragment = net.r_eg.IeXod.Evaluation.ItemSpec<net.r_eg.IeXod.Evaluation.ProjectProperty, net.r_eg.IeXod.Evaluation.ProjectItem>.ItemExpressionFragment;
...
namespace net.r_eg.IeXod.Evaluation
{
    ...
    /// </remarks>
    [DebuggerDisplay("{FullPath} [{ToolsVersion}@{SubToolsetVersion}][Sdk:{Xml?.Sdk}] #Imports={Imports.Count} #Properties={Properties.Count}(^{GlobalProperties.Count}) #Targets={Targets.Count} #Items={Items.Count}")]
    public class Project : ILinkableObject
    {
        ...
        public Project(IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection)
            : this(ProjectRootElement.Create(projectCollection, DefaultNewProjectTemplateOptions), globalProperties, toolsOptions, projectCollection)
        {
        }
        ...
        public Project(IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, NewProjectFileOptions newProjectFileOptions)
            : this(ProjectRootElement.Create(projectCollection, newProjectFileOptions), globalProperties, toolsOptions, projectCollection)
        {
        }
        ...
        /// <param name="globalProperties">Global properties to evaluate with. May be null in which case the containing project collection's global properties will be used.</param>
        /// <param name="toolsOptions">Options around toolset, sdk resolvers, and related. May be null.</param>
        public Project(ProjectRootElement xml, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions)
            : this(xml, globalProperties, toolsOptions, ProjectCollection.GlobalProjectCollection)
        {
        }
        ...
        /// <param name="toolsOptions">Options around toolset, sdk resolvers, and related. May be null.</param>
        /// <param name="projectCollection">The <see cref="ProjectCollection"/> the project is added to.</param>
        public Project(ProjectRootElement xml, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection)
            : this(xml, globalProperties, toolsOptions, projectCollection, ProjectLoadSettings.Default)
        {
        }
        ...
        public Project(ProjectRootElement xml, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings)
            : this(xml, globalProperties, toolsOptions, projectCollection, loadSettings, null)
        {
        }

        private Project(ProjectRootElement xml, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
        {
            ...
            SetProjectImpl(new ProjectImpl(this, xml, globalProperties, toolsOptions, loadSettings, evaluationContext))
                .Initialize(globalProperties, toolsOptions, loadSettings, evaluationContext);
        }
        ...
        /// <param name="globalProperties">Global properties to evaluate with. May be null in which case the containing project collection's global properties will be used.</param>
        /// <param name="toolsOptions">Options around toolset, sdk resolvers, and related. May be null.</param>
        public Project(XmlReader xmlReader, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions)
            : this(xmlReader, globalProperties, toolsOptions, ProjectCollection.GlobalProjectCollection)
        {
        }
        ...
        public Project(XmlReader xmlReader, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection)
            : this(xmlReader, globalProperties, toolsOptions, projectCollection, ProjectLoadSettings.Default)
        {
        }
        ...
        public Project(XmlReader xmlReader, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings)
            : this(xmlReader, globalProperties, toolsOptions, projectCollection, loadSettings, null)
        {
        }

        private Project(XmlReader xmlReader, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
        {
            ...
            SetProjectImpl(new ProjectImpl(this, xmlReader, globalProperties, toolsOptions, loadSettings, evaluationContext))
                .Initialize(globalProperties, toolsOptions, loadSettings, evaluationContext);
        }
        ...
        /// May throw IO-related exceptions.
        /// </summary>
        public Project(string projectFile, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions)
        ...
        /// <param name="projectCollection">The collection with which this project should be associated. May not be null.</param>
        public Project(string projectFile, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection)
            : this(projectFile, globalProperties, toolsOptions, projectCollection, ProjectLoadSettings.Default)
        {
        }
        ...
        /// <param name="projectCollection">The collection with which this project should be associated. May not be null.</param>
        /// <param name="loadSettings">The load settings for this project.</param>
        public Project(string projectFile, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings)
            : this(projectFile, globalProperties, toolsOptions, projectCollection, loadSettings, null)
        {
        }

        private Project(string projectFile, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectCollection projectCollection, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
        {
            ErrorUtilities.VerifyThrowArgumentNull(projectFile, nameof(projectFile));
            ErrorUtilities.VerifyThrowArgumentNull(projectCollection, nameof(projectCollection));

            ProjectCollection = projectCollection;
            var defaultImpl = SetProjectImpl(new ProjectImpl(this, projectFile, globalProperties, toolsOptions, loadSettings, evaluationContext));

            // Note: not sure why only this ctor flavor do TryUnloadProject
            // seems the XmlReader based one should also clean the same way.
            try
            {
                defaultImpl.Initialize(globalProperties, toolsOptions, loadSettings, evaluationContext);
            }
            catch (Exception ex)
            {
        ...
        private ProjectImpl SetProjectImpl(ProjectImpl impl)
        {
            implementationInternal = impl;
            implementation = impl;
            return impl;
        }
        ...
        private class ProjectImpl : ProjectLink, IProjectLinkInternal
        {
            ...
            /// <param name="loadSettings">The <see cref="ProjectLoadSettings"/> to use for evaluation.</param>
            /// <param name="evaluationContext">The evaluation context to use in case reevaluation is required</param>
            public ProjectImpl(Project owner, ProjectRootElement xml, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
            {
                ErrorUtilities.VerifyThrowArgumentNull(xml, nameof(xml));
            ...
            /// <param name="loadSettings">The load settings for this project.</param>
            /// <param name="evaluationContext">The evaluation context to use in case reevaluation is required</param>
            public ProjectImpl(Project owner, XmlReader xmlReader, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
            {
                ErrorUtilities.VerifyThrowArgumentNull(xmlReader, nameof(xmlReader));
                ErrorUtilities.VerifyThrowArgumentLengthIfNotNull(toolsOptions?.ToolsVersion, nameof(toolsOptions.ToolsVersion));
                ErrorUtilities.VerifyThrowArgumentNull(owner, nameof(owner));
            ...
            /// <param name="loadSettings">The load settings for this project.</param>
            /// <param name="evaluationContext">The evaluation context to use in case reevaluation is required</param>
            public ProjectImpl(Project owner, string projectFile, IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
            {
                ErrorUtilities.VerifyThrowArgumentNull(projectFile, nameof(projectFile));
                ErrorUtilities.VerifyThrowArgumentLengthIfNotNull(toolsOptions?.ToolsVersion, nameof(toolsOptions.ToolsVersion));
                ErrorUtilities.VerifyThrowArgumentNull(owner, nameof(owner));
            ...
            /// Tools options may be null.
            /// </summary>
            internal void Initialize(IDictionary<string, string> globalProperties, ProjectToolsOptions toolsOptions, ProjectLoadSettings loadSettings, EvaluationContext evaluationContext)
            {
                string subToolsetVersion = toolsOptions?.SubToolsetVersion;
                ...
                _data = new Data(Owner, globalPropertiesCollection, toolsOptions, canEvaluateElementsWithFalseConditions);
        ...
        internal class Data : IItemProvider<ProjectItem>, IPropertyProvider<ProjectProperty>, IEvaluatorData<ProjectProperty, ProjectItem, ProjectMetadata, ProjectItemDefinition>
        {
            ...
            /// </summary>
            internal Data(Project project, PropertyDictionary<ProjectPropertyInstance> globalProperties, ProjectToolsOptions toolsOptions, bool CanEvaluateElementsWithFalseConditions)
            {
                Project = project;
                GlobalPropertiesDictionary = globalProperties;
                ToolsOptions = toolsOptions ?? ProjectToolsOptions.Default;
            ...
            /// <summary>
            /// Tools options that was pushed for project evaluation implementation <see cref="ProjectImpl.Initialize" />.
            /// </summary>
            public ProjectToolsOptions ToolsOptions { get; private set; }
            ...
            /// </summary>
            public string ExplicitToolsVersion => ToolsOptions.ToolsVersion;
            ...
            /// the toolset properties for this project.  
            /// </summary>
            public string ExplicitSubToolsetVersion => ToolsOptions.SubToolsetVersion;
