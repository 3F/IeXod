...
using AvailableStaticMethods = net.r_eg.IeXod.Internal.AvailableStaticMethods;
            ...
            internal object Execute(object objectInstance, IPropertyProvider<T> properties, ExpanderOptions options, IElementLocation elementLocation)
            {
                ...
                try
                {
                    ...
                    if (objectInstance == null)
                    {
                        ...
                        if (_receiverType == typeof(net.r_eg.IeXod.Evaluation.IntrinsicFunctions))
                        {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        ProjectErrorUtilities.ThrowInvalidProject(elementLocation, "InvalidFunctionStaticMethodSyntax", _expression, ex.Message.Replace("net.r_eg.IeXod.Evaluation.IntrinsicFunctions.", "[MSBuild]::"));
                    }
                    else
                    {
                        // We ended up with something other than a function expression
...
#pragma warning restore 618, 612
            ...
            {
                if (receiverType == typeof(net.r_eg.IeXod.Evaluation.IntrinsicFunctions))
                {
