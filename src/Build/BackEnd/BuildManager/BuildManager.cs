...
namespace net.r_eg.IeXod.Execution
{
    ...
    public class BuildManager : INodePacketHandler, IBuildComponentHost, IDisposable
    {
        ...
        private enum BuildManagerState
        {
            ...
            /// <see cref="BuildManager.PendBuildRequest(net.r_eg.IeXod.Execution.BuildRequestData)"/>, <see cref="BuildManager.BuildRequest(net.r_eg.IeXod.Execution.BuildRequestData)"/>, <see cref="BuildManager.PendBuildRequest(GraphBuildRequestData)"/>, <see cref="BuildManager.BuildRequest(GraphBuildRequestData)"/>, and <see cref="BuildManager.EndBuild"/> may be called in this state.
            /// </summary>
            Building,
        ...
        internal void LoadSolutionIntoConfiguration(BuildRequestConfiguration config, BuildRequest request)
        {
            ...
            ProjectToolsOptions toolsOptions = config.ExplicitToolsVersionSpecified ? new ProjectToolsOptions(config.ToolsVersion) : ProjectToolsOptions.Default;
            ProjectInstance[] instances = ProjectInstance.LoadSolutionForBuild(config.ProjectFullPath, config.GlobalProperties, toolsOptions, _buildParameters, ((IBuildComponentHost)this).LoggingService, request.BuildEventContext, false /* loaded by solution parser*/, config.TargetNames, SdkResolverService, request.SubmissionId);
