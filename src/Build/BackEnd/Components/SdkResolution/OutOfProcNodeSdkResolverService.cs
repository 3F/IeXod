...
namespace net.r_eg.IeXod.BackEnd.SdkResolution
{
    ...
    /// sends requests to the main node that SDK resolution is handled in a central location.  This instance is registered in <see cref="net.r_eg.IeXod.Execution.OutOfProcNode"/>
