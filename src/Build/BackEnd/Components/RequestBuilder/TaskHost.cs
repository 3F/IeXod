...
using TaskLoggingContext = net.r_eg.IeXod.BackEnd.Logging.TaskLoggingContext;
using System.Threading.Tasks;
using net.r_eg.IeXod.BackEnd.Components.Caching;
...
namespace net.r_eg.IeXod.BackEnd
{
        ...
        IBuildEngine7
    {
        ...
        /// </summary>
        /// <param name="e">The event args</param>
        public void LogWarningEvent(net.r_eg.IeXod.Framework.BuildWarningEventArgs e)
        {
            lock (_callbackMonitor)
            {
                ErrorUtilities.VerifyThrowArgumentNull(e, "e");
        ...
        /// </summary>
        /// <param name="e">The event args</param>
        public void LogMessageEvent(net.r_eg.IeXod.Framework.BuildMessageEventArgs e)
        {
            lock (_callbackMonitor)
            {
                ErrorUtilities.VerifyThrowArgumentNull(e, "e");
        ...
        /// </summary>
        /// <param name="e">The event args</param>
        public void LogCustomEvent(net.r_eg.IeXod.Framework.CustomBuildEventArgs e)
        {
            lock (_callbackMonitor)
            {
                ErrorUtilities.VerifyThrowArgumentNull(e, "e");
