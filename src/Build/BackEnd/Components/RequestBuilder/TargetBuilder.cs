...
using ProjectLoggingContext = net.r_eg.IeXod.BackEnd.Logging.ProjectLoggingContext;
using ElementLocation = net.r_eg.IeXod.Construction.ElementLocation;
using BuildAbortedException = net.r_eg.IeXod.Exceptions.BuildAbortedException;
...
namespace net.r_eg.IeXod.BackEnd
{
    ...
    internal class TargetBuilder : ITargetBuilder, ITargetBuilderCallback, IBuildComponent
    {
        ...
        /// </summary>
        async Task<BuildResult[]> IRequestBuilderCallback.BuildProjects(string[] projectFiles, net.r_eg.IeXod.Collections.PropertyDictionary<ProjectPropertyInstance>[] properties, string[] toolsVersions, string[] targets, bool waitForResults, bool skipNonexistentTargets)
        {
