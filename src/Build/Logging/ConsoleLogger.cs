...
using BaseConsoleLogger = net.r_eg.IeXod.BackEnd.Logging.BaseConsoleLogger;
using SerialConsoleLogger = net.r_eg.IeXod.BackEnd.Logging.SerialConsoleLogger;
using ParallelConsoleLogger = net.r_eg.IeXod.BackEnd.Logging.ParallelConsoleLogger;
