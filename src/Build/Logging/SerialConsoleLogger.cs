...
using ColorSetter = net.r_eg.IeXod.Logging.ColorSetter;
using ColorResetter = net.r_eg.IeXod.Logging.ColorResetter;
using WriteHandler = net.r_eg.IeXod.Logging.WriteHandler;
