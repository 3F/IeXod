...
using LoggingService = net.r_eg.IeXod.BackEnd.Logging.LoggingService;
...
using XMakeElements = net.r_eg.IeXod.Shared.XMakeElements;
...
using FrameworkLocationHelper = net.r_eg.IeXod.Shared.FrameworkLocationHelper;
using Xunit;
using Xunit.Abstractions;
using Shouldly;

namespace net.r_eg.IeXod.UnitTests.Construction
{
