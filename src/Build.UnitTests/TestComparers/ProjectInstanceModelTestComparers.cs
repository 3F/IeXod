...
using Xunit;
using EvaluatorData =
    net.r_eg.IeXod.Evaluation.IEvaluatorData<net.r_eg.IeXod.Execution.ProjectPropertyInstance, net.r_eg.IeXod.Execution.ProjectItemInstance,
        net.r_eg.IeXod.Execution.ProjectMetadataInstance, net.r_eg.IeXod.Execution.ProjectItemDefinitionInstance>;

namespace net.r_eg.IeXod.Engine.UnitTests.TestComparers
{
