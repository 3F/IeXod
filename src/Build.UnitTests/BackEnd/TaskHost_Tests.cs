...
namespace net.r_eg.IeXod.UnitTests.BackEnd
{
    ...
    public class TaskHost_Tests
    {
        ...
        public void LogCustomAfterTaskIsDone()
        {
            string projectFileContents = @"
                    <Project xmlns='http://schemas.microsoft.com/developer/msbuild/2003' ToolsVersion='msbuilddefaulttoolsversion'>
                        <UsingTask TaskName='test' TaskFactory='CodeTaskFactory' AssemblyFile='$(IeXodBinPath)\IeXod.Tasks.dll' >
                            <Task>
        ...
        public void TasksCanGetGlobalProperties()
        {
            string projectFileContents = @"
<Project>
  <UsingTask TaskName='test' TaskFactory='RoslynCodeTaskFactory' AssemblyFile='$(IeXodBinPath)\IeXod.Tasks.dll'>
    <Task>
      <Code><![CDATA[
