...
using static net.r_eg.IeXod.UnitTests.ObjectModelHelpers;
...
");
        ...
        public void CancelledBuildInTaskHostWithDelay20()
        {
            ...
            string contents = CleanupFileContents(@"
<Project xmlns='msbuildnamespace' ToolsVersion='msbuilddefaulttoolsversion'>
 <UsingTask TaskName='net.r_eg.IeXod.Tasks.Exec' AssemblyName='net.r_eg.IeXod.Tasks.v3.5, Version=3.5.0.0, Culture=neutral, PublicKeyToken=4bbd2ef743db151e' TaskFactory='TaskHostFactory' Runtime='CLR2' />
 <Target Name='test'>
