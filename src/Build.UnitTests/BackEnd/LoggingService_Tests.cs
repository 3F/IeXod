...
namespace net.r_eg.IeXod.UnitTests.Logging
{
    ...
    public class LoggingService_Tests
    {
        ...
        public void ShutDownComponentExceptionsInForwardingLogger()
        {
            ...
            string className = "net.r_eg.IeXod.UnitTests.Logging.LoggingService_Tests+ShutdownLoggerExceptionFL";
            ...
            className = "net.r_eg.IeXod.UnitTests.Logging.LoggingService_Tests+ShutdownGeneralExceptionFL";
            ...
            className = "net.r_eg.IeXod.UnitTests.Logging.LoggingService_Tests+ShutdownStackoverflowExceptionFL";
        ...
        public void RegisterILoggerAndINodeLoggerGood()
        {
            ...
            Assert.Contains("net.r_eg.IeXod.BackEnd.Logging.CentralForwardingLogger", _initializedService.RegisteredLoggerTypeNames);
            Assert.Contains("net.r_eg.IeXod.UnitTests.Logging.LoggingService_Tests+RegularILogger", _initializedService.RegisteredLoggerTypeNames);
            Assert.Contains("net.r_eg.IeXod.Logging.ConsoleLogger", _initializedService.RegisteredLoggerTypeNames);
        ...
        public void RegisterDistributedLoggerServiceShutdown()
        {
            ...
            {
                _initializedService.ShutdownComponent();
                string className = "net.r_eg.IeXod.Logging.ConfigurableForwardingLogger";
        ...
        {
            string configurableClassName = "net.r_eg.IeXod.Logging.ConfigurableForwardingLogger";
            string distributedClassName = "net.r_eg.IeXod.Logging.DistributedFileLogger";
#if FEATURE_ASSEMBLY_LOCATION
            ...
            Assert.Contains("net.r_eg.IeXod.Logging.ConfigurableForwardingLogger", _initializedService.RegisteredLoggerTypeNames);
            Assert.Contains("net.r_eg.IeXod.UnitTests.Logging.LoggingService_Tests+RegularILogger", _initializedService.RegisteredLoggerTypeNames);
            Assert.Contains("net.r_eg.IeXod.Logging.DistributedFileLogger", _initializedService.RegisteredLoggerTypeNames);
            Assert.Contains("net.r_eg.IeXod.BackEnd.Logging.NullCentralLogger", _initializedService.RegisteredLoggerTypeNames);
        ...
        {
            string configurableClassNameA = "net.r_eg.IeXod.Logging.ConfigurableForwardingLogger";
            string configurableClassNameB = "net.r_eg.IeXod.Logging.ConfigurableForwardingLogger";
        ...
        public void RegisterDuplicateForwardingLoggerLogger()
        {
            ...
            {
                if (String.Compare("net.r_eg.IeXod.Logging.ConfigurableForwardingLogger", loggerName, StringComparison.OrdinalIgnoreCase) == 0)
                {
        ...
        {
            string configurableClassName = "net.r_eg.IeXod.Logging.ConfigurableForwardingLogger";
            string distributedClassName = "net.r_eg.IeXod.BackEnd.Logging.CentralForwardingLogger";
            ...
            foreach (string loggerName in _initializedService.RegisteredLoggerTypeNames)
            {
                if (String.Compare("net.r_eg.IeXod.BackEnd.Logging.CentralForwardingLogger", loggerName, StringComparison.OrdinalIgnoreCase) == 0)
                {
                    countForwardingLogger++;
                }
            }
