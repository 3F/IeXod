...
using static net.r_eg.IeXod.UnitTests.Helpers;

using ExpectedNodeBuildOutput = System.Collections.Generic.Dictionary<net.r_eg.IeXod.Graph.ProjectGraphNode, string[]>;
using OutputCacheDictionary = System.Collections.Generic.Dictionary<net.r_eg.IeXod.Graph.ProjectGraphNode, string>;

namespace net.r_eg.IeXod.Graph.UnitTests
{
