...
using ProjectHelpers = net.r_eg.IeXod.UnitTests.BackEnd.ProjectHelpers;
  ...
  <Target Name=""AfterBuild"">
    <Message Text=""[@(_Item->HasMetadata('a'), '|')]""/>
        ...
        public void StaticMethodErrorMessageHaveMethodName()
        {
            ...
            catch (net.r_eg.IeXod.Exceptions.InvalidProjectFileException e)
            {
 ...
 <Project DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
        ...
        public void PropertyFunctionStaticMethodDirectoryNameOfFileAbove()
        {
            ...
            try
            {
                ...
                Assert.Equal(net.r_eg.IeXod.Shared.FileUtilities.EnsureTrailingSlash(tempPath), net.r_eg.IeXod.Shared.FileUtilities.EnsureTrailingSlash(result));
  ...
  .ToString()
   .Substring(0, 5)
     .ToString())";
        ...
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetCurrentToolsDirectory())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetCurrentToolsDirectory()));
        }

        [Fact]
        public void PropertyFunctionIntrinsicFunctionGetToolsDirectory32()
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetToolsDirectory32())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetToolsDirectory32()));
        }

        [Fact]
        public void PropertyFunctionIntrinsicFunctionGetToolsDirectory64()
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetToolsDirectory64())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetToolsDirectory64()));
        }

        [Fact]
        public void PropertyFunctionIntrinsicFunctionGetMSBuildSDKsPath()
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetMSBuildSDKsPath())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetMSBuildSDKsPath()));
        }
        ...
        public void PropertyFunctionIntrinsicFunctionGetVsInstallRoot()
        {
            ...
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetVsInstallRoot())", "X", "_", vsInstallRoot);
        }

        [Fact]
        public void PropertyFunctionIntrinsicFunctionGetMSBuildExtensionsPath()
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetMSBuildExtensionsPath())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetMSBuildExtensionsPath()));
        }

        [Fact]
        public void PropertyFunctionIntrinsicFunctionGetProgramFiles32()
        {
            TestPropertyFunction("$([net.r_eg.IeXod.Evaluation.IntrinsicFunctions]::GetProgramFiles32())", "X", "_", EscapingUtilities.Escape(IntrinsicFunctions.GetProgramFiles32()));
        }
