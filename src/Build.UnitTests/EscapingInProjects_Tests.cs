...
using FileUtilities = net.r_eg.IeXod.Shared.FileUtilities;
using InvalidProjectFileException = net.r_eg.IeXod.Exceptions.InvalidProjectFileException;
using ResourceUtilities = net.r_eg.IeXod.Shared.ResourceUtilities;
using Xunit;
using Xunit.Abstractions;

namespace net.r_eg.IeXod.UnitTests.EscapingInProjects_Tests
{
    /// <summary>
    ...
    public class SimpleScenarios : IDisposable
    {
        ...
        public void SemicolonInPropertyPassedIntoITaskItemParam()
        {
            MockLogger logger = Helpers.BuildProjectWithNewOMExpectSuccess(String.Format(@"
                ...
                <Project ToolsVersion=`msbuilddefaulttoolsversion` xmlns=`http://schemas.microsoft.com/developer/msbuild/2003`>
                    ...
                    <UsingTask TaskName=`net.r_eg.IeXod.UnitTests.EscapingInProjects_Tests.MyTestTask` AssemblyFile=`{0}` />
        ...
        public void SemicolonInPropertyPassedIntoITaskItemParam_UsingTaskHost()
        {
            MockLogger logger = Helpers.BuildProjectWithNewOMExpectSuccess(String.Format(@"
                ...
                <Project ToolsVersion=`msbuilddefaulttoolsversion` xmlns=`http://schemas.microsoft.com/developer/msbuild/2003`>
                    ...
                    <UsingTask TaskName=`net.r_eg.IeXod.UnitTests.EscapingInProjects_Tests.MyTestTask` AssemblyFile=`{0}` TaskFactory=`TaskHostFactory` />
        ...
        public void SpecialCharactersInMetadataValueEvaluation()
        {
            ...
            ProjectItem item = project.AddItem("None", "MetadataTests", new Dictionary<string, string> {
                {"EscapedSemicolon", "%3B"}, //net.r_eg.IeXod.Evaluation.ProjectCollection.Escape(";")
                {"EscapedDollarSign", "%24"}, //net.r_eg.IeXod.Evaluation.ProjectCollection.Escape("$")
            }).Single();
