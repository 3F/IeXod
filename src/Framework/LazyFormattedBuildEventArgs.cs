        ...
        private static string FormatString(CultureInfo culture, string unformatted, params object[] args)
        {
            ...
            if ((args != null) && (args.Length > 0))
            {
                ...
                catch (FormatException ex)
                {
                    ...
                    //             at net.r_eg.IeXod.Framework.LazyFormattedBuildEventArgs.FormatString(CultureInfo culture, String unformatted, Object[] args) in d:\W8T_Refactor\src\vsproject\xmake\Framework\LazyFormattedBuildEventArgs.cs:line 263
