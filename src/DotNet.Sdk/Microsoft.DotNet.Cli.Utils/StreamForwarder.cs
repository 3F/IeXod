...
namespace Microsoft.DotNet.Cli.Utils
{
    public sealed class StreamForwarder
    {
        ...
        private void ThrowIfForwarderSet()
        {
            if (_writeLine != null)
            {
                throw new InvalidOperationException(Resources.GetString("WriteLineForwarderSetPreviously"));
            }
        }
        ...
        private void ThrowIfCaptureSet()
        {
            if (_capture != null)
            {
                throw new InvalidOperationException(Resources.GetString("AlreadyCapturingStream"));
            }
        }
    }
}
