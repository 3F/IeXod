...
{
    public class GivenAnIeXodMSBSdkResolver : SdkTest
    {

        public GivenAnIeXodMSBSdkResolver(ITestOutputHelper logger) : base(logger)
        {
        }
        ...
        {
            var resolver = new MSBSdkResolver();

            Assert.Equal(8000, resolver.Priority);
            Assert.Equal(typeof(MSBSdkResolver).FullName, resolver.Name);
        }
        ...
        public void ItReturnsNullIfTheVersionFoundDoesNotSatisfyTheMinVersion()
        {
            ...
            result.Version.Should().BeNull();
            result.Warnings.Should().BeNullOrEmpty();
            result.Errors.Should().Contain(string.Format(Resources.GetString("NETCoreSDKSmallerThanMinimumRequestedVersion"), "99.99.99", "999.99.99"));
        }
        ...
        public void ItReturnsNullWhenTheSDKRequiresAHigherVersionOfMSBuildThanAnyOneAvailable()
        {
            ...
            result.Version.Should().BeNull();
            result.Warnings.Should().BeNullOrEmpty();
            result.Errors.Should().Contain(string.Format(Resources.GetString("MSBuildSmallerThanMinimumVersion"), "99.99.99", "2.0", "1.0"));
        }
        ...
        public void ItReturnsNullWhenTheDefaultVSRequiredSDKVersionIsHigherThanTheSDKVersionAvailable()
        {
            ...
            result.Version.Should().BeNull();
            result.Warnings.Should().BeNullOrEmpty();
            result.Errors.Should().Contain(string.Format(Resources.GetString("NETCoreSDKSmallerThanMinimumVersionRequiredByVisualStudio"), "1.0.1", "1.0.4"));
        }
        ...
        public void ItReturnsNullWhenTheTheVSRequiredSDKVersionIsHigherThanTheSDKVersionAvailable()
        {
            ...
            result.Version.Should().BeNull();
            result.Warnings.Should().BeNullOrEmpty();
            result.Errors.Should().Contain(string.Format(Resources.GetString("NETCoreSDKSmallerThanMinimumVersionRequiredByVisualStudio"), "1.0.1", "2.0.0"));
        }
