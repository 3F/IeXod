...
using net.r_eg.IeXod.Engine.UnitTests.Globbing;
...
using ProvenanceResultTupleList = System.Collections.Generic.List<(string, net.r_eg.IeXod.Evaluation.Operation, net.r_eg.IeXod.Evaluation.Provenance, int)>;
...
using ToolLocationHelper = net.r_eg.IeXod.Utilities.ToolLocationHelper;
using TargetDotNetFrameworkVersion = net.r_eg.IeXod.Utilities.TargetDotNetFrameworkVersion;
using Shouldly;
using Xunit;
using Xunit.Abstractions;

namespace net.r_eg.IeXod.UnitTests.OM.Definition
{
    /// <summary>
    ...
    <I Include=`i2`>
      <M>m2</M>
        ...
        public void BuildEvaluationUsesCustomLoggers()
        {
            ...
            string importFileName = net.r_eg.IeXod.Shared.FileUtilities.GetTemporaryFile() + ".proj";
