...
<Project ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
    ...
    <Import Project='$(MSBuildToolsPath)\Microsoft.CSharp.targets'/>
        ...
        {
            ProjectRootElement projectXml1 = ProjectRootElement.Create();
            projectXml1.FullPath = net.r_eg.IeXod.Shared.FileUtilities.GetTemporaryFile();
...
<Project DefaultTargets=""Build"" ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""msbuildnamespace"">
        ...
        public void SolutionCanNotBeOpened()
        {
            ...
            Assert.Throws<InvalidProjectFileException>(() =>
            {
                ...
                try
                {
                    tempFileSentinel = net.r_eg.IeXod.Shared.FileUtilities.GetTemporaryFile();
        ...
        public void ProjectCanNotBeOpened()
        {
            Assert.Throws<InvalidProjectFileException>(() =>
            {
                ...
                try
                {
                    ...
                    projectFile = net.r_eg.IeXod.Shared.FileUtilities.GetTemporaryFile();
        ...
        public void SolutionCorrupt()
        {
            Assert.Throws<InvalidProjectFileException>(() =>
            {
                ...
                try
                {
                    solutionFile = net.r_eg.IeXod.Shared.FileUtilities.GetTemporaryFile();
