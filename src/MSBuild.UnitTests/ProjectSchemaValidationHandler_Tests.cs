...
using System.Xml;
using net.r_eg.IeXod.CommandLine;
...
");
        ...
        /// <summary>
        /// MSBuild schemas are embedded as a resource into net.r_eg.IeXod.Engine.UnitTests.dll.
        ...
        private string[] PrepareSchemaFiles()
        {
            ...
            Stream msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.CommandLine.UnitTests.net.r_eg.IeXod.xsd");
            ...
            string msbuildTempXsdFilename = Path.Combine(msbuildXsdRootDirectory, "net.r_eg.IeXod.xsd");
            ...
            msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.CommandLine.UnitTests.net.r_eg.IeXod.Core.xsd");
            msbuildXsdStreamReader = new StreamReader(msbuildXsdStream);
            msbuildXsdContents = msbuildXsdStreamReader.ReadToEnd();
            string msbuildTempXsdFilename2 = Path.Combine(msbuildXsdSubDirectory, "net.r_eg.IeXod.Core.xsd");
            File.WriteAllText(msbuildTempXsdFilename2, msbuildXsdContents);

            msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.CommandLine.UnitTests.net.r_eg.IeXod.CommonTypes.xsd");
            msbuildXsdStreamReader = new StreamReader(msbuildXsdStream);
            msbuildXsdContents = msbuildXsdStreamReader.ReadToEnd();
            string msbuildTempXsdFilename3 = Path.Combine(msbuildXsdSubDirectory, "net.r_eg.IeXod.CommonTypes.xsd");
