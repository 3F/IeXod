...
namespace net.r_eg.IeXod.UnitTests
{
    public class TypeLoader_Tests
    {
        ...
        public void Basic()
        {
            ...
            Assert.True(TypeLoader.IsPartialTypeNameMatch("net.r_eg.IeXod.Tasks.Csc", "net.r_eg.IeXod.Tasks.Csc")); // ==> exact match
            Assert.True(TypeLoader.IsPartialTypeNameMatch("net.r_eg.IeXod.Tasks.Csc", "Csc")); // ==> partial match
            Assert.True(TypeLoader.IsPartialTypeNameMatch("net.r_eg.IeXod.Tasks.Csc", "Tasks.Csc")); // ==> partial match
        ...
        {
            Assert.False(TypeLoader.IsPartialTypeNameMatch("net.r_eg.IeXod.Tasks.Csc", "Vbc"));
        }

        [Fact]
        public void Regress_Mutation_ParameterOrderDoesntMatter()
        {
            Assert.True(TypeLoader.IsPartialTypeNameMatch("Csc", "net.r_eg.IeXod.Tasks.Csc"));
        }
