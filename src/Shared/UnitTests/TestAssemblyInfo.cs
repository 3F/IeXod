...
public class MSBuildTestAssemblyFixture : IDisposable
{
    ...
    {
        //  Set field to indicate tests are running in the TestInfo class in net.r_eg.IeXod.Framework.
        //  See the comments on the TestInfo class for an explanation of why it works this way.
        var frameworkAssembly = typeof(net.r_eg.IeXod.Framework.ITask).Assembly;
        var testInfoType = frameworkAssembly.GetType("net.r_eg.IeXod.Framework.TestInfo");
