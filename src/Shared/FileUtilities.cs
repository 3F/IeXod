...
#else
        private static readonly net.r_eg.IeXod.Shared.Concurrent.ConcurrentDictionary<string, bool> FileExistenceCache = new net.r_eg.IeXod.Shared.Concurrent.ConcurrentDictionary<string, bool>(StringComparer.OrdinalIgnoreCase);
#endif
