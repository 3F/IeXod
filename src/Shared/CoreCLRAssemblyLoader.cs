...
namespace net.r_eg.IeXod.Shared
{
    ...
    internal sealed class CoreClrAssemblyLoader
    {
        ...
        private static readonly Version _currentAssemblyVersion = new Version(net.r_eg.IeXod.Shared.MSBuildConstants.CurrentAssemblyVersion);
        ...
        private Assembly TryGetWellKnownAssembly(AssemblyLoadContext context, AssemblyName assemblyName)
        {
            ...
            // of the net.r_eg.IeXod.* assembly.
