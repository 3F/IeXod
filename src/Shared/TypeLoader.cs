...
namespace net.r_eg.IeXod.Shared
{
    ...
    internal class TypeLoader
    {
        ...
        /// "net.r_eg.IeXod.Tasks.Csc" and "net.r_eg.IeXod.Tasks.Csc"     ==> exact match
        /// "net.r_eg.IeXod.Tasks.Csc" and "Csc"                           ==> partial match
        /// "net.r_eg.IeXod.Tasks.Csc" and "Tasks.Csc"                     ==> partial match
