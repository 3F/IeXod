    ...
    internal static class TaskLoader
    {
        ...
        internal static bool IsTaskClass(Type type, object unused)
        {
            return (type.GetTypeInfo().IsClass && !type.GetTypeInfo().IsAbstract && (
                ...
                type.GetTypeInfo().GetInterface("net.r_eg.IeXod.Framework.ITask") != null));
#else
                type.GetInterfaces().Any(interfaceType => interfaceType.FullName == "net.r_eg.IeXod.Framework.ITask")));
#endif
        }
