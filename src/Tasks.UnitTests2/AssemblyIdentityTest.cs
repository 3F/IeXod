    ...
    public class AssemblyIdentityTest
    {
        ...
        public void IsFrameworkAssemblyTest()
        {
            ...
            if (hasVersion(listOfInstalledFrameworks, "Version=v2.0"))
            {
                ...
                // Test 2.0 CLR binary
                // "net.r_eg.IeXod.Engine" Version="2.0.0.0" PublicKeyToken="4bbd2ef743db151e" Culture="neutral" ProcessorArchitecture="MSIL" FileVersion="2.0.50727.3026" InGAC="true" />
                AssemblyIdentity clr2Binary = new AssemblyIdentity("net.r_eg.IeXod.Engine", "2.0.0.0", "4bbd2ef743db151e", "neutral", "MSIL");
            ...
            {
                // Test 3.5 CLR binary
                // AssemblyName="net.r_eg.IeXod.Tasks.v3.5" Version="3.5.0.0" PublicKeyToken="4bbd2ef743db151e" Culture="neutral" ProcessorArchitecture="MSIL" InGAC="false" />
                AssemblyIdentity clr35Binary = new AssemblyIdentity("net.r_eg.IeXod.Tasks.v3.5", "3.5.0.0", "4bbd2ef743db151e", "neutral", "MSIL");
