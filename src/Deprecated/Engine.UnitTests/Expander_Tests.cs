...
using BuildEngine = net.r_eg.IeXod.BuildEngine;
...
namespace net.r_eg.IeXod.UnitTests
{
    ...
    public class Expander_Tests
    {
        ...
        /// </summary>
        [Test]
        [ExpectedException(typeof(net.r_eg.IeXod.BuildEngine.InvalidProjectFileException))]
        ...
        public void PropertyFunctionStaticMethodDirectoryNameOfFileAbove()
        {
            ...
            try
            {
                ...
                Assertion.AssertEquals(net.r_eg.IeXod.BuildEngine.Shared.FileUtilities.EnsureTrailingSlash(tempPath), net.r_eg.IeXod.BuildEngine.Shared.FileUtilities.EnsureTrailingSlash(result));
