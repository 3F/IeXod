...
namespace net.r_eg.IeXod.UnitTests.Project_Tests
{
    [TestFixture]
    ...
    /// </summary>
    /// <owner>RGoel</owner>
    public class WashCar : net.r_eg.IeXod.Utilities.Task
    {
    ...
    /// </summary>
    /// <owner>RGoel</owner>
    public class Message : net.r_eg.IeXod.Utilities.Task
    {
        private string text;
        public string Text
        {
        ...
        public void CustomTaskRegisteredFullInvokedFull()
        {
            ...
            MockLogger ml = ObjectModelHelpers.BuildProjectExpectSuccess(String.Format(@"
                    ...
                    <Project ToolsVersion=`msbuilddefaulttoolsversion` xmlns=`msbuildnamespace`>
                        ...
                        <UsingTask TaskName=`net.r_eg.IeXod.UnitTests.Project_Tests.WashCar` AssemblyFile=`{0}`/>

                        <Target Name=`Build`>
                            <net.r_eg.IeXod.UnitTests.Project_Tests.WashCar/>
                        </Target>
            ...
            MockLogger ml = ObjectModelHelpers.BuildProjectExpectSuccess(String.Format(ObjectModelHelpers.CleanupFileContents(@"
                    ...
                    <Project ToolsVersion=`msbuilddefaulttoolsversion` xmlns=`msbuildnamespace`>
                        ...
                        <Target Name=`Build`>
                            ...
                            <net.r_eg.IeXod.UnitTests.Project_Tests.Message Text=`Being`/>

                            <!-- This should run the shipping Message task. -->
                            <net.r_eg.IeXod.Tasks.Message Text=`John`/>
    ...
    public class Miscellaneous
    {
        ...
        {
            ResourceManager resourceManager = new ResourceManager("net.r_eg.IeXod.Engine.Resources.Strings", typeof(Project).Assembly);
