    ...
    public class ToolsetConfigurationReaderTests
    {
        ...
        public void MSBuildToolsetsTest_EmptyElement()
        {
            ToolsetConfigurationReaderTestHelper.WriteConfigFile(@"
                 <configuration>
                   <configSections>
                     <section name=""msbuildToolsets"" type=""net.r_eg.IeXod.BuildEngine.ToolsetConfigurationSection, net.r_eg.IeXod.Engine"" />
                   </configSections>
                   <msbuildToolsets />
                 </configuration>");
                 ...
                 <configuration>
                   ...
                   <runtime>
                     <assemblyBinding xmlns=""urn:schemas-microsoft-com:asm.v1"">
                       <dependentAssembly>
                          <assemblyIdentity name=""net.r_eg.IeXod.Framework"" publicKeyToken=""4bbd2ef743db151e"" culture=""neutral""/>
