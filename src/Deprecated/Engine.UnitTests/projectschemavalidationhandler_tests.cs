...
");
        ...
        {
            Stream msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.Engine.Unittest.net.r_eg.IeXod.xsd");
            ...
            msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.Engine.Unittest.net.r_eg.IeXod.Core.xsd");
            ...
            msbuildXsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("net.r_eg.IeXod.Engine.Unittest.net.r_eg.IeXod.CommonTypes.xsd");
            msbuildXsdStreamReader = new StreamReader(msbuildXsdStream);
            msbuildXsdContents = msbuildXsdStreamReader.ReadToEnd();
