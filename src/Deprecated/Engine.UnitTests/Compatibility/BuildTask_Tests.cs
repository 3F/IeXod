...
namespace net.r_eg.IeXod.UnitTests.OM.OrcasCompatibility
{
    ...
    public sealed class BuildTask_Tests
    {
        ...
        public void TypeTaskExists()
        {
            ...
            Assertion.AssertEquals(0, String.Compare(task.Type.ToString(), "net.r_eg.IeXod.Tasks.Message"));
        }
        ...
        public void ExecuteExpectedTrue()
        {
            ...
            Assertion.AssertEquals(0, String.Compare(task.Type.ToString(), "net.r_eg.IeXod.Tasks.Message", StringComparison.OrdinalIgnoreCase));
