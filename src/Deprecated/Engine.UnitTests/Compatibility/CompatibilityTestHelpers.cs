...
namespace net.r_eg.IeXod.UnitTests.OM.OrcasCompatibility
{
    ...
    public static class CompatibilityTestHelpers
    {
        ...
        /// </summary>
        internal static readonly string SchemaPathBuildCore = Path.Combine(SuiteBinPath, @"MSBuild\net.r_eg.IeXod.Core.xsd");
        ...
        /// </summary>
        internal static readonly string SchemaPathMSBuild = Path.Combine(SuiteBinPath, @"net.r_eg.IeXod.xsd");
