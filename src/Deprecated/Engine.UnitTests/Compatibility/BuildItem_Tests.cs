...
namespace net.r_eg.IeXod.UnitTests.OM.OrcasCompatibility
{
    ...
    public sealed class BuildItem_Tests
    {
        ...
        /// Verifying that net.r_eg.IeXod.BuildEngine.Shared.InternalErrorException is thrown
        /// </summary>
        [Test]
        ...
        ///     expected net.r_eg.IeXod.BuildEngine.Shared.InternalErrorException is thrown.
        /// </summary>
        ...
        private void BuildItemNameGetSetNullExpectedToThrow(BuildItem item, bool setting)
        {
            ...
            Assertion.Fail("Expected net.r_eg.IeXod.BuildEngine.Shared.InternalErrorException not thrown");
        }
