...
using error = net.r_eg.IeXod.BuildEngine.Shared.ErrorUtilities;
...
namespace net.r_eg.IeXod.BuildEngine
{
    ...
    /// </summary>
    /// <owner>RGoel</owner>
    [Obsolete("This class has been deprecated. Please use net.r_eg.IeXod.Evaluation.ProjectCollection from the net.r_eg.IeXod assembly instead.")]
    public class Engine
    {
            ...
            get
            {
                if (engineVersion == null)
                {
                    ...
                    try
                    {
                        ...
                        // work when net.r_eg.IeXod.Engine.dll has been shadow-copied, for example
                        // in scenarios where NUnit is loading net.r_eg.IeXod.Engine.
