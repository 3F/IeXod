...
namespace net.r_eg.IeXod.BuildEngine
{
    ...
    internal static class FunctionConstants
    {
        ...
        private static void InitializeAvailableMethods()
        {
            ...
            availableStaticMethods.TryAdd("MSBuild", new Tuple<string, Type>(null, typeof(net.r_eg.IeXod.BuildEngine.IntrinsicFunctions)));
            ...
            availableStaticMethods.TryAdd("net.r_eg.IeXod.Utilities.ToolLocationHelper", new Tuple<string, Type>("net.r_eg.IeXod.Utilities.ToolLocationHelper, net.r_eg.IeXod.Utilities.Core, Version=" + MSBuildConstants.CurrentAssemblyVersion + ", Culture=neutral, PublicKeyToken=4bbd2ef743db151e", null));
        }
    }
}
