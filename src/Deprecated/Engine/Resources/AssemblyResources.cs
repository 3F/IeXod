...
namespace net.r_eg.IeXod.BuildEngine.Shared
{
    ...
    static internal class AssemblyResources
    {
        ...
        // assembly resources
        private static readonly ResourceManager resources = new ResourceManager("net.r_eg.IeXod.Engine.Strings", Assembly.GetExecutingAssembly());
        // shared resources
        private static readonly ResourceManager sharedResources = new ResourceManager("net.r_eg.IeXod.Engine.Strings.shared", Assembly.GetExecutingAssembly());
    }
}
