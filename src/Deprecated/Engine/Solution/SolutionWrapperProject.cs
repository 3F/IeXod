...
namespace net.r_eg.IeXod.BuildEngine
{
    ...
    static public class SolutionWrapperProject
    {
        ...
        private static void CreateSolutionProject(SolutionParser solution, Project msbuildProject, BuildEventContext projectBuildEventContext, string wrapperProjectToolsVersion, Engine parentEngine, string solutionProjectCache)
        {
            ...
            {
                taskAssembly = "net.r_eg.IeXod.Tasks, Version=2.0.0.0, Culture=neutral, PublicKeyToken=4bbd2ef743db151e";
            }
            else
            {
                taskAssembly = "net.r_eg.IeXod.Tasks.v3.5, Version=3.5.0.0, Culture=neutral, PublicKeyToken=4bbd2ef743db151e";
            }

            // Fully qualified class names are more performant
            msbuildProject.AddNewUsingTaskFromAssemblyName("net.r_eg.IeXod.Tasks.CreateTemporaryVCProject", taskAssembly);
            msbuildProject.AddNewUsingTaskFromAssemblyName("net.r_eg.IeXod.Tasks.ResolveVCProjectOutput", taskAssembly);
