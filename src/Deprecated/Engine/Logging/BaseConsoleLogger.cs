...
namespace net.r_eg.IeXod.BuildEngine
{
    ...
    abstract internal class BaseConsoleLogger : INodeLogger
    {
        ...
        internal void IsRunningWithCharacterFileType()
        {
            ...
            IntPtr stdHandle = net.r_eg.IeXod.BuildEngine.Shared.NativeMethods.GetStdHandle(net.r_eg.IeXod.BuildEngine.Shared.NativeMethods.STD_OUTPUT_HANDLE);

            if (stdHandle != net.r_eg.IeXod.BuildEngine.NativeMethods.InvalidHandle)
            {
                uint fileType = net.r_eg.IeXod.BuildEngine.Shared.NativeMethods.GetFileType(stdHandle);

                // The std out is a char type(LPT or Console)
                runningWithCharacterFileType = fileType == net.r_eg.IeXod.BuildEngine.Shared.NativeMethods.FILE_TYPE_CHAR;
            }
            else
            {
