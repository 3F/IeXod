...
using net.r_eg.IeXod.Conversion;
using Microsoft.VisualStudio.TestTools.UnitTesting;

using ProjectRootElement = net.r_eg.IeXod.Construction.ProjectRootElement;
        ...
        public void ConvertFSharpDev10ProjectFile()
        {
            ...
            string sampleFSharpDev10ProjectFile = @"
                <Project ToolsVersion=""4.0"" DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
                  ...
                  <Import Project=""$(MSBuildExtensionsPath32)\FSharp\1.0\Microsoft.FSharp.Targets"" Condition=""!Exists('$(MSBuildBinPath)\net.r_eg.IeXod.Tasks.v4.0.dll')"" />
                  <Import Project=""$(MSBuildExtensionsPath32)\..\Microsoft F#\v4.0\Microsoft.FSharp.Targets"" Condition="" Exists('$(MSBuildBinPath)\net.r_eg.IeXod.Tasks.v4.0.dll')"" />
                  <!-- To modify your build process, add your task inside one of the targets below and uncomment it. 
                         Other similar extension points exist, see Microsoft.Common.targets.
                    <Target Name=""BeforeBuild"">
                    </Target>
      ...
      <FlavorProperties GUID=""{349c5851-65df-11da-9384-00065b846f21}"">
        ...
        public void VS2010DeployProjectDeprecated()
        {
            ...
            try
            {
                ...
                Assert.Fail("There should have been a net.r_eg.IeXod.Exceptions.InvalidProjectFileException");
            }
            catch (Exception e)
            {
                Assert.IsInstanceOfType(e, typeof(net.r_eg.IeXod.Exceptions.InvalidProjectFileException));
            }
        }
