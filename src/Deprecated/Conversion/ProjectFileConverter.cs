...
using ProjectLoadSettings = net.r_eg.IeXod.BuildEngine.ProjectLoadSettings;
using OldProject = net.r_eg.IeXod.BuildEngine.Project;
using OldEngine = net.r_eg.IeXod.BuildEngine.Engine;
        ...
        {           
            ...
            foreach (ProjectImportElement importElement in xmakeProject.Imports)
            {
                if (equals(importElement.Project, fsharpFS10TargetsPath) || equals(importElement.Project, fsharpFS10TargetsPath32))
                {
                    ...
                    if (equals(@"!Exists('$(MSBuildToolsPath)\net.r_eg.IeXod.Tasks.v4.0.dll')", fsharpTargetsFS10Import.Condition)
                        || equals(@"!Exists('$(MSBuildBinPath)\net.r_eg.IeXod.Tasks.v4.0.dll')", fsharpTargetsFS10Import.Condition))
                    {
