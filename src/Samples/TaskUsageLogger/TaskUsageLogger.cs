...
namespace TaskUsageLogger
{
    ...
    ///   most default tasks are incorrectly recorded as coming from net.r_eg.IeXod.Tasks.v4.0.dll,
    ...
    public class TaskUsageLogger : Logger
    {
        ...
        /// <summary>
        /// Returns true if the two names "mean" the same thing e.g. "net.r_eg.IeXod.Tasks.AL" vs just "AL".
        /// </summary>
        /// <remarks>
