...
namespace net.r_eg.IeXod.Tasks.Deployment.ManifestUtilities
{
    internal class MetadataReader : IDisposable
    {
        ...
        [SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "net.r_eg.IeXod.Tasks.IMetaDataImport2.GetCustomAttributeByName(System.UInt32,System.String,System.IntPtr@,System.UInt32@)", Justification = "We verify the valueLen, we don't care what the return value is in this case")]
