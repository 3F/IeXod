...
namespace net.r_eg.IeXod.Tasks.Deployment.ManifestUtilities
{
    internal class ComImporter
    {
        ...
        private readonly ResourceManager _resources = new ResourceManager("net.r_eg.IeXod.Tasks.Core.Strings.ManifestUtilities", System.Reflection.Assembly.GetExecutingAssembly());
