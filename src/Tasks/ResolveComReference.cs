...
using UtilitiesProcessorArchitecture = net.r_eg.IeXod.Utilities.ProcessorArchitecture;
...
namespace net.r_eg.IeXod.Tasks
{
    internal interface IResolveComReferenceTaskContract
    {
        ...
        /// Should be a member of net.r_eg.IeXod.Utilities.ProcessorArchitecture.
        /// </summary>
    ...
    /// </summary>
    public sealed partial class ResolveComReference : net.r_eg.IeXod.Tasks.TaskExtension, IResolveComReferenceTaskContract
    {
        #region Properties
