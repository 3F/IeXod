...
namespace net.r_eg.IeXod.Tasks
{
    ...
    internal static class GlobalAssemblyCache
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "net.r_eg.IeXod.Tasks.IAssemblyCache.QueryAssemblyInfo(System.UInt32,System.String,net.r_eg.IeXod.Tasks.ASSEMBLY_INFO@)", Justification = "We use the out parameters to determine if we got a good assembly back or not")]
