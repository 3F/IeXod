...
namespace net.r_eg.IeXod.Tasks
{
    ...
    public class WinMDExp : ToolTaskExtension
    {
        ...
        {
            return SdkToolsPathUtility.GeneratePathToTool(SdkToolsPathUtility.FileInfoExists, net.r_eg.IeXod.Utilities.ProcessorArchitecture.CurrentProcessArchitecture, SdkToolsPath, ToolExe, Log, true);
        }
