...
namespace net.r_eg.IeXod.Tasks.Xaml
{
    /// <summary>
    ...
    internal class TaskGenerator
    {
        ...
        private static void GenerateImports(CodeNamespace codeNamespace)
        {
            string[] imports =
            {
                ...
                "System.Diagnostics",
                "System.IO",
                "net.r_eg.IeXod.Utilities",
                "net.r_eg.IeXod.Framework",
                "net.r_eg.IeXod.Tasks.Xaml",
            };
        ...
        private void GenerateConstructor(CodeTypeDeclaration taskClass)
        {
            ...
            // new System.Resources.ResourceManager("net.r_eg.IeXod.NativeTasks.Strings", System.Reflection.Assembly.GetExecutingAssembly()))
