...
#region Properties
        ...
        /// <summary>
        /// net.r_eg.IeXod.Utilities.ExecutableType of ResGen.exe.  Used to determine whether or not
        ...
        private bool ComputePathToResGen()
        {
            ...
            else
            {
                _resgenPath = SdkToolsPathUtility.GeneratePathToTool(
                    ...
                    net.r_eg.IeXod.Utilities.ProcessorArchitecture.CurrentProcessArchitecture,
                    SdkToolsPath,
                    "resgen.exe",
                    Log,
                    ExecuteAsTool);
