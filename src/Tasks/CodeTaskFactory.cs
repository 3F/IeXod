...
namespace net.r_eg.IeXod.Tasks
{
    ...
    public class CodeTaskFactory : ITaskFactory
    {
        ...
        /// </summary>
        private readonly string[] _defaultUsingNamespaces = { "System", "System.Collections", "System.Collections.Generic", "System.Text", "System.Linq", "System.IO", "net.r_eg.IeXod.Framework", "net.r_eg.IeXod.Utilities" };
        ...
        private static List<string> DefaultReferencedAssemblies
        {
            get
            {
                if (s_defaultReferencedAssemblies == null)
                {
                    ...
                    // We also want to add references to two MSBuild assemblies: net.r_eg.IeXod.Framework.dll and 
                    // net.r_eg.IeXod.Utilities.Core.dll.  If we just let the CLR unify the simple name, it will 
