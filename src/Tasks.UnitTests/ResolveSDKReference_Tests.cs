...
using SDKReference = net.r_eg.IeXod.Tasks.ResolveSDKReference.SDKReference;
using ProcessorArchitecture = net.r_eg.IeXod.Utilities.ProcessorArchitecture;
using net.r_eg.IeXod.Evaluation;
using System.Linq;
using net.r_eg.IeXod.Execution;
using Xunit;

namespace net.r_eg.IeXod.UnitTests.ResolveSDKReference_Tests
{
    public class ResolveSDKReferenceTestFixture
    {
        private net.r_eg.IeXod.UnitTests.MockEngine.GetStringDelegate _resourceDelegate = new net.r_eg.IeXod.UnitTests.MockEngine.GetStringDelegate(AssemblyResources.GetString);
