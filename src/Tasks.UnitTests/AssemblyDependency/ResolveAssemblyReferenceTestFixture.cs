...
using net.r_eg.IeXod.Tasks.AssemblyDependency;
...
namespace net.r_eg.IeXod.UnitTests.ResolveAssemblyReference_Tests
{
    public class ResolveAssemblyReferenceTestFixture : IDisposable
    {
        ...
        internal static net.r_eg.IeXod.Shared.DirectoryExists directoryExists = new net.r_eg.IeXod.Shared.DirectoryExists(DirectoryExists);
        internal static net.r_eg.IeXod.Tasks.GetDirectories getDirectories = new net.r_eg.IeXod.Tasks.GetDirectories(GetDirectories);
        internal static net.r_eg.IeXod.Tasks.GetAssemblyName getAssemblyName = new net.r_eg.IeXod.Tasks.GetAssemblyName(GetAssemblyName);
        internal static net.r_eg.IeXod.Tasks.GetAssemblyMetadata getAssemblyMetadata = new net.r_eg.IeXod.Tasks.GetAssemblyMetadata(GetAssemblyMetadata);
#if FEATURE_WIN32_REGISTRY
        internal static net.r_eg.IeXod.Shared.GetRegistrySubKeyNames getRegistrySubKeyNames = new net.r_eg.IeXod.Shared.GetRegistrySubKeyNames(GetRegistrySubKeyNames);
        internal static net.r_eg.IeXod.Shared.GetRegistrySubKeyDefaultValue getRegistrySubKeyDefaultValue = new net.r_eg.IeXod.Shared.GetRegistrySubKeyDefaultValue(GetRegistrySubKeyDefaultValue);
#endif
        internal static net.r_eg.IeXod.Tasks.GetLastWriteTime getLastWriteTime = new net.r_eg.IeXod.Tasks.GetLastWriteTime(GetLastWriteTime);
        internal static net.r_eg.IeXod.Tasks.GetAssemblyRuntimeVersion getRuntimeVersion = new net.r_eg.IeXod.Tasks.GetAssemblyRuntimeVersion(GetRuntimeVersion);
        internal static net.r_eg.IeXod.Tasks.GetAssemblyPathInGac checkIfAssemblyIsInGac = new net.r_eg.IeXod.Tasks.GetAssemblyPathInGac(GetPathForAssemblyInGac);
#if FEATURE_WIN32_REGISTRY
        internal static net.r_eg.IeXod.Shared.OpenBaseKey openBaseKey = new net.r_eg.IeXod.Shared.OpenBaseKey(GetBaseKey);
#endif
        internal net.r_eg.IeXod.UnitTests.MockEngine.GetStringDelegate resourceDelegate = new net.r_eg.IeXod.UnitTests.MockEngine.GetStringDelegate(AssemblyResources.GetString);
        internal static net.r_eg.IeXod.Tasks.IsWinMDFile isWinMDFile = new net.r_eg.IeXod.Tasks.IsWinMDFile(IsWinMDFile);
        internal static net.r_eg.IeXod.Tasks.ReadMachineTypeFromPEHeader readMachineTypeFromPEHeader = new net.r_eg.IeXod.Tasks.ReadMachineTypeFromPEHeader(ReadMachineTypeFromPEHeader);
  ...
  <File AssemblyName=""net.r_eg.IeXod"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  <File AssemblyName=""net.r_eg.IeXod.Conversion.v4.0"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  <File AssemblyName=""net.r_eg.IeXod.Engine"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  <File AssemblyName=""net.r_eg.IeXod.Framework"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  <File AssemblyName=""net.r_eg.IeXod.Tasks.v4.0"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  <File AssemblyName=""net.r_eg.IeXod.Utilities.v4.0"" Version=""4.0.0.0"" PublicKeyToken=""4bbd2ef743db151e"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
  ...
  <File AssemblyName=""XamlBuildTask"" Version=""4.0.0.0"" PublicKeyToken=""31bf3856ad364e35"" Culture=""neutral"" ProcessorArchitecture=""MSIL"" InGac=""true"" />
        ...
        protected static List<string> s_existentFiles = new List<string>
        {
            ...
            Path.Combine(s_myComponentsRootPath, "net.r_eg.IeXod.dll"),
