...
namespace net.r_eg.IeXod.UnitTests.ResolveAssemblyReference_Tests
{
    ...
    public sealed class VerifyTargetFrameworkHigherThanRedist : ResolveAssemblyReferenceTestFixture
    {
        ...
        public void HigherThanHighestInRedistListForMSBuildAssembly()
        {
            ...
            ITaskItem[] items = new ITaskItem[]
            {
                new TaskItem("net.r_eg.IeXod")
            };

            string redistString = "<FileList Redist='Microsoft-Windows-CLRCoreComp-Random' >" +
                                  "<File AssemblyName='net.r_eg.IeXod' Version='4.0.0.0' PublicKeyToken='4bbd2ef743db151e' Culture='neutral' ProcessorArchitecture='MSIL' FileVersion='4.0.0.0' InGAC='true' />" +
                                  "</FileList >";
            ...
            e.AssertLogContains("net.r_eg.IeXod.dll");
