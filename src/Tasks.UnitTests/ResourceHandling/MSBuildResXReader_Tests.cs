...
using net.r_eg.IeXod.Tasks.ResourceHandling;
using net.r_eg.IeXod.Tasks.UnitTests.ResourceHandling;
using net.r_eg.IeXod.UnitTests;
using Shouldly;
using Xunit;
using Xunit.Abstractions;

namespace net.r_eg.IeXod.Tasks.UnitTests.GenerateResource
{
